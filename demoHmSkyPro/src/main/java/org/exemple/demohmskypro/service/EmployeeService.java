...
public class EmployeeService {
    ...
    public Employee removeEmployee(int id) {
        ...
        return null; // для тестов – в production лучше возвращать Optional
    }
    ...
    private double calculateTax(int salary, String taxType) {
        switch (taxType) {
            case "PROPORTIONAL": return salary * 0.13;
            case "PROGRESSIVE":
                if (salary <= 150) return salary * 0.13;
                else if (salary <= 350) return salary * 0.17;
                else return salary * 0.21;
            default: return 0;
        }
    }
